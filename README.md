...
- **Quantum Key Distribution (QKD) simulation**: Demonstrates how secure keys can be generated using quantum principles.
- **End-to-End Encryption**: Messages are encrypted using advanced cryptographic standards securely distributed between peers.
- **Privacy-First Architecture**: No central server can intercept or read the message contents.

## Installation

Clone the repository and run the setup scripts to start your secure messaging node.
