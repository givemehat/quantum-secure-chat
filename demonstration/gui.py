...
def make_btn(parent, text, cmd, bg=BLUE, width=14):
    ...
    return tk.Button(
        ...
        bg=bg, fg="#111111",              
        activebackground=bg, activeforeground="#111111",
...
class App:
    ...
    def _ui(self):
        ...
        tk.Label(
            kc, textvariable=self.key_var,
            fg=FG_KEY, bg=ENTRY_BG,
            font=FM, anchor="w",
            padx=10, pady=7,
        ...
        tk.Label(bar_row, text="Strength:", fg=FG_DIM, bg=CARD, font=FS).pack(side="left")

        self.bar = ttk.Progressbar(
            bar_row, style="Bar.Horizontal.TProgressbar",
        ...
        make_btn(br, "Decrypt", self._decrypt, bg="#3a6ab0", width=12).pack(side="left", padx=(8, 0))
        make_btn(br, "Clear",   self._clear,   bg="#7a3a3a", width=8 ).pack(side="left", padx=(8, 0))
        ...
        self.status_lbl = tk.Label(
            ...
            fg=FG_DIM, bg=BG, font=FS, anchor="w",
        )
